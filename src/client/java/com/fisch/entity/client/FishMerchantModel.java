package com.fisch.entity.client;
...
public class FishMerchantModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leska2_r1 = bodywear.addOrReplaceChild("leska2_r1", CubeListBuilder.create().texOffs(82, 121).addBox(-1.9612F, -12.4966F, 3.9569F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
				...
				.texOffs(124, 86).addBox(-1.0F, -14.0F, 1.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition headwear2 = partdefinition.addOrReplaceChild("headwear2", CubeListBuilder.create().texOffs(-4, 79).addBox(-7.0F, -6.0F, -8.0F, 14.0F, 0.0F, 15.0F, new CubeDeformation(0.0F))
				...
				.texOffs(62, 89).addBox(-4.0F, -11.0F, -4.0F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.right_leg.xRot = (float)Math.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount * 0.5F;
		this.left_leg.xRot = (float)Math.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.4F * limbSwingAmount * 0.5F;
	}
