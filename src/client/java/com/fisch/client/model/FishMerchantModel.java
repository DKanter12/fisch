...
public class FishMerchantModel<T extends Entity> extends EntityModel<T> {
	...
	// ИСПРАВЛЕНО: Заменил "modid" на "fisch", чтобы слой правильно находился в игре
	...
	public FishMerchantModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headwear = partdefinition.addOrReplaceChild("headwear", CubeListBuilder.create().texOffs(63, 9).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.51F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition headwear2 = partdefinition.addOrReplaceChild("headwear2", CubeListBuilder.create()
				// Добавили микро-толщину 0.01F вместо 0.0F, чтобы поля шляпы были видны снизу
				.texOffs(-4, 79).addBox(-7.0F, -6.0F, -8.0F, 14.0F, 0.01F, 15.0F, new CubeDeformation(0.0F))
				...
				// Тут тоже исправил 0.0F на 0.01F для задней плоской части
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		// ИСПРАВЛЕНО: Добавлена анимация, чтобы торговец не был парализован

		// Поворот головы за игроком
		this.head.yRot = netHeadYaw * ((float) Math.PI / 180F);
		this.head.xRot = headPitch * ((float) Math.PI / 180F);

		// Шапки тоже должны крутиться вместе с головой
